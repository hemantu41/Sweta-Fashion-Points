...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'product.freeSize': 'One Size Fits All',
    'product.deliverTo': 'Deliver to:',
    'product.changeAddress': 'Change',
    'product.addAddress': 'Add an address',
    'product.loginDelivery': 'Log in to set delivery address',
  ...
  hi: {
    ...
    'product.viewDetails': 'विस्तार देखें',
    'product.color': 'रंग',
    'product.size': 'साइज़',
    'product.sizeChart': 'साइज़ चार्ट',
    'product.selectSize': 'कृपया एक साइज़ चुनें',
    'product.freeSize': 'एक ही साइज़ में फिट',
    'product.deliverTo': 'पहुंचाएं:',
    'product.changeAddress': 'बदलें',
    'product.addAddress': 'पता जोड़ें',
    'product.loginDelivery': 'डेलिवरी पता लगाने के लिए लॉग इन करें',
