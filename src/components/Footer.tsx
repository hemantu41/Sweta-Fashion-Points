        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-5">
              <span className="text-2xl font-bold text-[#C9A962]" style={{ fontFamily: 'var(--font-playfair), Playfair Display, serif' }}>Insta Fashion Points</span>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-bold mb-5 text-white" style={{ fontFamily: 'var(--font-playfair), Playfair Display, serif' }}>{t('footer.quickLinks')}</h3>
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/terms-and-conditions" className="text-gray-400 hover:text-white transition-colors text-sm tracking-wide">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link href="/return-policy" className="text-gray-400 hover:text-white transition-colors text-sm tracking-wide">
                  Return Policy
                </Link>
              </li>
              <li>
                <Link href="/seller" className="text-[#C9A962] hover:text-white transition-colors text-sm tracking-wide font-medium flex items-center gap-2">
          ...
          {/* Categories */}
          <div>
            <h3 className="text-lg font-bold mb-5 text-white" style={{ fontFamily: 'var(--font-playfair), Playfair Display, serif' }}>{t('footer.categories')}</h3>
            <ul className="space-y-3">
              <li>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg font-bold mb-5 text-white" style={{ fontFamily: 'var(--font-playfair), Playfair Display, serif' }}>{t('footer.contact')}</h3>
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+918294153256" className="text-gray-400 hover:text-white transition-colors text-sm">
                  +91 82941 53256
                </a>
              </li>
              <li className="flex items-center space-x-3">
