        ...
        <div className="max-w-[1300px] mx-auto px-6 sm:px-8 lg:px-14 py-12 md:py-14">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <div className="max-w-sm">
              ...
              <p className="mt-2 text-[12.5px] text-[#888888] font-light leading-relaxed">
                {language === 'hi'
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:min-w-[420px]">
              <input
                ...
                className="flex-1 bg-[#161616] border border-[#2A2A2A] text-white text-[13px] px-5 py-3.5 placeholder-[#555555] focus:outline-none focus:border-[#C9A962] transition-colors duration-200"
              />
      ...
      <div className="max-w-[1300px] mx-auto px-6 sm:px-8 lg:px-14 py-16 md:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-10">
          ...
          <div>
            ...
            <p className="text-[12.5px] text-[#7A7A7A] font-light leading-relaxed mb-8 max-w-[220px]">
              {language === 'hi'
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 rounded-full bg-[#1A1A1A] border border-[#2E2E2E] flex items-center justify-center text-[#777777] hover:bg-[#C9A962] hover:text-[#0E0E0E] hover:border-[#C9A962] hover:scale-110 transition-all duration-250"
              >
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="text-[12.5px] text-[#8A8A8A] font-light tracking-wide hover:text-[#C9A962] transition-colors duration-200"
                  >
                    {item.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-[12.5px] text-[#8A8A8A] font-light leading-snug">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="text-[12.5px] text-[#8A8A8A] font-light hover:text-[#C9A962] transition-colors duration-200"
                >
                  +91 82941 53256
                </a>
              </li>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-[12.5px] text-[#8A8A8A] font-light leading-snug">9:00 AM – 5:30 PM IST</p>
                  <p className="text-[11px] text-[#666666] font-light mt-0.5 flex items-center gap-1.5">
      ...
      <div className="border-t border-[#181818]">
        <div className="max-w-[1300px] mx-auto px-6 sm:px-8 lg:px-14 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-[11px] text-[#666666] tracking-wide font-light">
            ...
            <button
              ...
              className="group flex items-center gap-2 text-[10px] tracking-[0.2em] uppercase text-[#666666] hover:text-[#C9A962] transition-colors duration-200 font-semibold"
            >
              {language === 'hi' ? 'ऊपर जाएं' : 'Back to Top'}
              <span className="flex items-center justify-center w-6 h-6 border border-[#3A3A3A] group-hover:border-[#C9A962] transition-colors duration-200">
