...
const womensCategories: WomensCategory[] = [
  {
    ...
    descriptionHi: 'सुरुचिपूर्ण और स्टाइलिश',
    link: '/womens?category=kurti',
  ...
  },
  {
    ...
    descriptionHi: 'आधुनिक और शानदार',
    link: '/womens?category=dresses',
  ...
  },
  {
    ...
    descriptionHi: 'आराम और स्टाइल',
    link: '/womens?category=bottomwear',
  ...
  },
  {
    id: 'undergarments',
    name: 'Undergarments',
    nameHi: 'अंडरगार्मेंट्स',
    description: 'Essential Comfort',
    descriptionHi: 'आवश्यक आराम',
    link: '/womens?category=undergarments',
        ...
        <div className="text-center mt-10">
          ...
          >
            <span className="tracking-wide">
              {language === 'hi' ? 'सभी महिलाओं के उत्पाद देखें' : 'View All Women\'s Products'}
            </span>
