            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-xl text-sm font-mono text-gray-500 focus:outline-none focus:ring-2 bg-gray-50 ${saveError.includes('slug') ? 'border-red-400 focus:ring-red-200' : 'border-gray-200 focus:ring-[#C49A3C]/30'}`}
                />
                <p className="text-xs text-gray-400 mt-1">Slugs must be unique across all categories. If taken, add a suffix like <span className="font-mono">-mens</span> or <span className="font-mono">-kids</span>.</p>
              </div>
              <div>
