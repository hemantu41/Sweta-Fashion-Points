            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="tel:+919608063673" className="text-[#d4458b] hover:underline">
                    +91 96080 63673
                  </a>
                </div>
              </div>
              ...
              <div className="pt-4 space-y-3">
                <a
                  ...
                  className="flex items-center justify-center space-x-2 w-full bg-green-500 text-white py-3 rounded-full font-medium hover:bg-green-600 transition-colors"
                >
                ...
                <a
                  ...
                  className="flex items-center justify-center space-x-2 w-full bg-[#d4458b] text-white py-3 rounded-full font-medium hover:bg-[#b8366e] transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center space-x-2 w-full border-2 border-gray-200 text-gray-700 py-3 rounded-full font-medium hover:border-[#d4458b] hover:text-[#d4458b] transition-colors"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
