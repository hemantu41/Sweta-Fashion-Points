...
export default function WomensPage() {
  ...
  const getCategoryName = () => {
    ...
    const categoryMap: any = {
      ...
      'ethnic': language === 'hi' ? 'एथनिक वियर' : 'Ethnic Wear',
      'seasonal': language === 'hi' ? 'सीज़नल' : 'Seasonal',
    };
    ...
    <div className="min-h-screen bg-[#FAF7F2]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex items-center gap-2 text-sm mb-6">
          ...
          <Link href="/womens" className="text-[#6B6B6B] hover:text-[#722F37] transition-colors">
          ...
          <div className="flex-1">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-[#E8E2D9] p-4 mb-6">
              <div className="flex flex-wrap gap-2">
                ...
                >
                  {language === 'hi' ? 'एथनिक वियर' : 'Ethnic Wear'}
                </button>
                <button
