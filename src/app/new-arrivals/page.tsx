      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {newArrivals.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-6">
              {language === 'hi'
                ? 'WhatsApp पर संपर्क करें नए arrivals की जानकारी के लिए'
                : 'Contact us on WhatsApp to know about new arrivals'}
            </p>
            <a
              href="https://wa.me/919608063673?text=Hi!%20I%20want%20to%20know%20about%20new%20arrivals"
              target="_blank"
        ...
        <div className="mt-12 bg-gradient-to-r from-[#722F37] to-[#8B3D47] rounded-2xl p-8 text-white text-center">
          ...
          <p className="opacity-90 mb-6 max-w-xl mx-auto">
            {language === 'hi'
              ? 'हमें WhatsApp पर मैसेज करें और नए collection की जानकारी सबसे पहले पाएं'
              : 'Message us on WhatsApp to be the first to know about new collections'}
          </p>
          <a
            href="https://wa.me/919608063673?text=Hi!%20Please%20notify%20me%20about%20new%20arrivals"
            target="_blank"
            rel="noopener noreferrer"
