  ...
  try {
    ...
    if (type === 'email') {
      ...
      const { error: emailError } = await resend.emails.send({
        ...
        to: value,
        subject: 'Verify Your Email - Sweta Fashion Points',
        html: `
      ...
      // Send OTP via SMS
      const smsMessage = `Your OTP for account registration at Sweta Fashion Points is ${otp}. Valid for 10 minutes. Do not share with anyone.`;
