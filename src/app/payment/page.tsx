    ...
    return (
      <div className="min-h-screen bg-[#FAF7F2] py-12 px-4">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-[#6B6B6B] mb-6">Thank you for shopping with Insta Fashion Points</p>
      ...
      <div className="min-h-screen bg-[#FAF7F2] py-12 px-4">
        <div className="max-w-lg mx-auto text-center">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <a href="tel:+918294153256" className="text-[#722F37] font-medium hover:underline">
