...
export default function OrdersPage() {
  ...
  // Admin-only: order recovery sync
  ...
  return (
    <div style={{ fontFamily: 'var(--font-dm-sans, DM Sans, sans-serif)' }} className="space-y-5 pb-8">
      ...
      {/* Admin-only: Order Recovery Tool */}
      {user?.isAdmin && (
        <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-base">⚠️</span>
            <span className="text-sm font-bold text-amber-800">Order Recovery Tool</span>
            <span className="text-xs text-amber-600">— Sync a paid order that&apos;s missing from this list</span>
          </div>
          <div className="flex flex-wrap gap-2 items-center">
            <input
              ...
              className="flex-1 min-w-[240px] px-3 py-2 text-sm border border-amber-300 rounded-lg bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-amber-400"
            />
            <button
