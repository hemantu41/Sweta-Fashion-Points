  ...
  return (
    <div className="max-w-xl space-y-5" style={{ fontFamily: 'var(--font-dm-sans, DM Sans, sans-serif)' }}>
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8 text-center">
        ...
        <p className="text-sm text-gray-400">Account settings and preferences will be available here soon.</p>
        <p className="text-xs text-gray-300 mt-3">To update your business details, contact support at support@fashionpoints.co.in</p>
      </div>
    </div>
  );
}
